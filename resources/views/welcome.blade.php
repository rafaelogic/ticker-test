                ...
                <div class="mt-16">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                       <form action="/price" method="post">
                            ...
                            <input type="date" id="from-date" name="date_from">

                            <!-- Time Dropdown -->
                            <label for="from-time">To:</label>
                            <input type="date" id="to-date" name="date_to">
                        ...
                        <table class="table-fixed">
                            <thead>
                                <tr>
                                <th class="border px-4 py-2">Lowest Price</th>
                                <th class="border px-4 py-2">Date</th>
                                <th class="border px-4 py-2">Highest Price</th>
                                <th class="border px-4 py-2">Date</th>
                                </tr>
                            </thead>
                            <tbody>
